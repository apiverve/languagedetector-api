...
namespace APIVerve\Languagedetector;
...
/**
 * Client for the Language Detector API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/languagedetector?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/languagedetector';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LanguagedetectorClient] {$message}\n";
        }
    }
}
