...
namespace APIVerve.API.LanguageDetector
{
    ...
    /// <summary>
    /// Client for the LanguageDetector API
    /// </summary>
    public class LanguageDetectorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/languagedetector";
        ...
        public LanguageDetectorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LanguageDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LanguageDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, LanguageDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(LanguageDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(LanguageDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(LanguageDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(LanguageDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(LanguageDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(LanguageDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(LanguageDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(LanguageDetectorQueryOptions options)
        {
