...
// Request contains the parameters for the Language Detector API.
//
// Parameters:
...
// ResponseData contains the data returned by the Language Detector API.
